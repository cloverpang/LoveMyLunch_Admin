                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    ...
                                                    <div class="portlet-body form">
                                                        ...
                                                        <div class="modal-footer">
														    <button type="button" class="btn blue" v-show="viewType" @click="changeViewType" v-if="$_has('component_company_update')"><i class="fa fa-pencil"></i> 修改 </button>
                                                            <button type="button" class="btn dark btn-outline" data-dismiss="modal" @click="handleClose"> 关闭 </button>
                                                            <button type="submit" class="btn green" v-show="!viewType" :disabled="actionProgress" v-if="$_has('component_company_update')">
